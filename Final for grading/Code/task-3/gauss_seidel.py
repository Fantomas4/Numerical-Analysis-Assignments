...
print("\n*** Executing for n = 10. Please wait... ***")
print("=> X vector for n = 10 is: ", generate_a_matrix(10))
print("\n*** Executing for n = 10000. Please wait... ***")
print("=> X vector for n = 10000 is: ", generate_a_matrix(10000))
